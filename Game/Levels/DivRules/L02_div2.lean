...
**Lean Quirk Alert:** If you just write `have h2 : 2 ∣ 10 := by ...`, Lean will assume 2 and 10 are natural numbers (`ℕ`), but our theorems expect integers (`ℤ`). To fix this, you must explicitly tell Lean the type of at least one number.
Write your statement like this: `have h2 : (2 : ℤ) ∣ 10 := by ...`
"
